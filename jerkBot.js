exports.handleMessage = function(bot, msg, callback) {
    ...
    if(msg.text.indexOf("epic") > -1) {
         bot.sendMessage(chatID, "wow this really wasn't all that 'epic' tbh.", {reply_to_message_id: msg["message_id"]});
    ...
    if(msg.text.indexOf("so") > -1 && msg.text.indexOf("cool") > -1) {
        bot.sendMessage(chatID, "You don't get out much, do you kiddo?", {reply_to_message_id: msg["message_id"]});
        return callback(true);
    }
    ...
    if(msg.text.indexOf("scared") > -1 && msg.text.indexOf("the") > -1 && msg.text.indexOf("shit") > -1 && msg.text.indexOf("out") > -1 && msg.text.indexOf("of") > -1 && msg.text.indexOf("me") > -1) {
        bot.sendMessage(chatID, "^^their shit is still inside them", {reply_to_message_id: msg["message_id"]});
        return callback(true);
    }
    if(msg.text.indexOf("wow") > -1) {
        bot.sendMessage(chatID, "bored me to tears", {reply_to_message_id: msg["message_id"]});
        return callback(true);
    }
